...
class Validation():
    ...
    model_meta = {
        ...
        #     'model_path': '/home/lib/generate_seg/train_crack500_viz/crack500_deeplabv3plus/version_0/checkpoints/step=16000.ckpt',
        #     'log_name': 'deeplabv3plus',
        # },
        'bisenet': {
            'config': '/home/lib/generate_seg/config/train_crack500_bisenet.yaml',
            'model_path': '/home/lib/generate_seg/train_crack500_viz/crack500_bisenet/version_1/checkpoints/step=14000.ckpt',
            'log_name': 'bisenet',
        },
        # 'unet': {
    ...
    def val(self, val_dataloader):
        ...
        with open(self.log_csv_path, "w") as csvfile: 
            ...
            for batch_idx, batch in enumerate(tqdm(val_dataloader)):
                ...
                with torch.no_grad():
                    rows, preds = self.model_module.test_all(batch, batch_idx)
...
if __name__ == "__main__":
    ...
    data_module = DataModule(num_classes=2,
                             ...
                             val_config='/home/lib/generate_seg/config/dataset/crack500_val.yaml')

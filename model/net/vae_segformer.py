...
class MixVisionTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        self.reconstruct1 = VAE(in_channels=embed_dims[0],
                                input_size=128,
                                latent_dim=128)
        ...
        self.norm1_vae_trans = norm_layer(embed_dims[0])

        self.concat1 = SKFF(in_channels=embed_dims[0], height=2)
    ...
    def forward(self, x):
        ...
        reconstruct1, mean, logvar = self.reconstruct1(x.detach())
        reconstructs = [x.detach(), reconstruct1 + x.detach(), mean, logvar]

        recon = reconstruct1.detach() + x
...
class SegFormer(nn.Module):
    ...
    def forward(self, inputs):
        ...
        x, recons = self.backbone.forward(inputs)
...
class SKFF(nn.Module):
    ...
    def __init__(self, in_channels, height=3, reduction=8, bias=False):
        ...
        self.weight_vale = torch.zeros(size=(1, height, in_channels, 1, 1))

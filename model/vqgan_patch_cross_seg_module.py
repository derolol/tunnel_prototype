...
from model.net.cross_segformer import CrossSegFormer
...
class ModelModule(LightningModule):
    ...
    def __init__(self,
        ...
        self.segformer = CrossSegFormer(num_classes=3,
    ...
    def forward(self, img):
        ...
        seg = self.segformer(img, reconstruct_images)
    ...
    def calculate_loss(self, out, batch, batch_idx, mode):
        ...
        seg = out["seg"]
        reconstruct_images = out["reconstruct_images"]
        ...
        for loss_name, f in self.loss_fn.items():
            if loss_name == "segment_loss":
                ...
                loss = f(reconstruct_images, images)
            else:
                continue
